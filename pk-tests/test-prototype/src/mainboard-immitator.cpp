...
extern "C" void app_main(void) {
    ...
    ESP_LOGI("MAIN", "Starting mainboard immitator..");
    ESP_LOGI("MAIN", "Waiting for other side to start handshake..");
...
/*
bool processIncomingSerialMessages(uart_port_t uart_num, char *messageBuffer, int &messageLength) {
    int len = uart_read_bytes(UART_NUM_1, (uint8_t*)messageBuffer, MAX_MESSAGE_LENGTH, 100 / portTICK_PERIOD_MS);
    messageLength = len;
    return len > 0;
}
*/
