...
class MainboardAbstractUART : public MainboardInterface {
   public:
     ...
     * @param rx_buf_size optional default 200
     * @param tx_buf_size optional default 200
     */
    ...
    esp_err_t init() override {
        ...
        // FIXME: Need to check if we need to enable RX/TX interrupts

        // Create a task to handler UART event from ISR
        // FIXME: Guess we need to make stack size flexible
